...
function Library:CreateWindow(GameName)
     if game.CoreGui:FindFirstChild("DarkWare") then
          game.CoreGui:FindFirstChild("DarkWare"):Destroy()
     end

     local DarkWare = Instance.new("ScreenGui")
     ...
     DarkWare.Name = "DarkWare"
     DarkWare.Parent = game.CoreGui
     DarkWare.Enabled = true
     DarkWare.ResetOnSpawn = false

     MainHolder_1.Name = "MainHolder"
     MainHolder_1.Parent = DarkWare
     ...
     ToggleGUIHolder_1.Parent = DarkWare
